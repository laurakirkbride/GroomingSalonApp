...
namespace GroomingUI.Controllers
{
    ...
    {
        private readonly SalonModel _context;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AppointmentId,CustomerId,PetId,AppointmentDate,CreatedDate")] Appointment appointment)
        {
